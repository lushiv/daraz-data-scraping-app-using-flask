...
scraping_url = 'https://www.daraz.com.np/womens-shoes/'


#driver path for chrome browser
DRIVER_PATH = webdriver.Chrome(executable_path = r"/home/programmer-0/ehub-scraping-python/chromedriver") #TODO: path get from config.ini
...
def get_daraz_data(payload):
    try:
        ...
        driver = DRIVER_PATH
        print("******************************************************************************")
        print("******************* SCRAPING STARTED WAIT FEW MINUTES **************************")
        ...
        #Quit the first driver for Memory Cleaning
        driver.quit()
